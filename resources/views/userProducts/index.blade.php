    ...
    <div class="page-container">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="card text-center rounded shadow-sm">
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <small class="small text-muted">Ціна: {{ $product->price }} грн</small>
                                    <p class="my-2">{{ Str::limit($product->description, 150) }}</p>
                                </div>
        ...
        <div class="page-sidebar text-center">
            ...
            <form id="filter-form" action="{{ route('userProducts.index') }}" method="GET">
                ...
                @if(!empty($activeFilters['categories']) || !empty($activeFilters['search']) || !empty($activeFilters['from_price']) || !empty($activeFilters['to_price']))
